...
${SUDO} dnf -y install boost boost-devel
...
(set -x; \
cmake -DTARGET_ARCH=x86_64 -DCMAKE_BUILD_TYPE=Release -DGOOGLE_TEST=1 -DCMAKE_INSTALL_PREFIX=/usr -DBoost_USE_STATIC_LIBS=OFF ${src_dir}/percolator; \
)
make -j 4
make test
make -j 4 package
